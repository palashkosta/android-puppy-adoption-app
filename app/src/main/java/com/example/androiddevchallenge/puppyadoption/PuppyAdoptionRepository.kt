...
object PuppyAdoptionRepository {
    ...
    private fun createDummyPuppyList(): List<PuppyItem> {
        ...
        val puppyItem10 = PuppyItem(id = 10,
            name = "Weimaraner1",
            group = "Sporting Dogs",
        ...
        val puppyItem11 = PuppyItem(id = 11,
